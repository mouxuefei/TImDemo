package com.edocyun.timchat.vp.adapter;
...
import com.edocyun.timchat.vp.api.ImageMsgBody;
import com.edocyun.timchat.vp.api.Message;
import com.edocyun.timchat.vp.api.MsgBody;
import com.edocyun.timchat.vp.api.MsgSendStatus;
import com.edocyun.timchat.vp.api.MsgType;
import com.edocyun.timchat.vp.api.TextMsgBody;
import com.edocyun.timchat.vp.api.VideoMsgBody;
   ...
   private static final int RECEIVE_AUDIO = R.layout.item_audio_receive;
    ...
    public ChatAdapter(Context context, List<Message> data) {
        ...
        setMultiTypeDelegate(new MultiTypeDelegate<Message>() {
            ...
            protected int getItemType(Message entity) {
              boolean isSend = entity.getSenderId().equals(Constants.mTargetId);
    ...
    private void setStatus(BaseViewHolder helper, Message item) {
        ...
        if (msgContent instanceof TextMsgBody
            ...
            boolean isSend = item.getSenderId().equals(Constants.mSenderId);
            if (isSend){
